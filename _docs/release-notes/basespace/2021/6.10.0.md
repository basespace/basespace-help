...
### Features
 ...
 - Released BaseSpace command-line interface (CLI) version 1.4.0. View detailed release notes [here](https://developer.basespace.illumina.com/docs/content/documentation/cli/cli-releasenotes).
